...
export const BetterAuthUserMenu: FC<BetterAuthUserMenuProps> = ({ user }) => {
  ...
  return (
    <>
      ...
      <div
        id="better-auth-user-menu"
        class="inline-flex items-center w-8 h-8 relative"
      ...
      <script
        dangerouslySetInnerHTML={{
          ...
          (function() {
            ...
            container.innerHTML = \`
              <div class="relative">
                <button id="user-menu-button" class="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all" aria-expanded="false" aria-haspopup="true" data-testid="user-menu-button">
                ...
                <div id="user-menu-dropdown" class="hidden origin-top-right absolute right-0 mt-2 w-64 sm:w-72 rounded-xl shadow-xl bg-white ring-1 ring-black ring-opacity-5 z-50 overflow-hidden" data-testid="user-menu-dropdown">
                  ...
                  <div class="py-1">
                    <a href="/admin" class="group flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors" data-testid="user-menu-dashboard">
                    ...
                    \${role === 'admin' ? \`
                    <a href="/admin/churches" class="group flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors" data-testid="user-menu-manage-churches">
                      <svg class="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                      Manage Churches
                    </a>
                    <a href="/admin/users" class="group flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors" data-testid="user-menu-manage-users">
                      <svg class="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                      </svg>
                      Manage Users
                    </a>
                    <a href="/admin/cache" class="group flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors" data-testid="user-menu-cache">
                      <svg class="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="border-t border-gray-100">
                    <button onclick="window.location.href='/auth/signout'" class="group flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors" data-testid="user-menu-signout">
                      <svg class="mr-3 h-4 w-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
