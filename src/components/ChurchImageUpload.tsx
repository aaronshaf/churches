...
export const ChurchImageUpload: FC<ChurchImageUploadProps> = ({ 
  churchImages = [], 
  domain, 
  r2Domain,
  churchId 
        ...
        >
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
              <label for="churchImages" class="relative cursor-pointer rounded-md font-medium text-primary-600 hover:text-primary-500">
