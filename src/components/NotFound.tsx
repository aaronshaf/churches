  ...
  return (
    <div class="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex flex-col justify-center relative overflow-hidden">
      ...
      <div class="absolute inset-0 overflow-hidden">
        <svg class="absolute -top-40 -right-40 h-80 w-80 text-primary-100 opacity-50" fill="currentColor" viewBox="0 0 100 100">
          <circle cx="50" cy="50" r="40" />
        </svg>
        <svg class="absolute -bottom-32 -left-32 h-64 w-64 text-primary-100 opacity-30" fill="currentColor" viewBox="0 0 100 100">
          <circle cx="50" cy="50" r="40" />
        </svg>
      </div>
      ...
      <div class="relative">
        <div class="max-w-2xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative max-w-md mx-auto">
              <form action="/" method="get" class="relative">
                <input
                  type="text"
                  name="search"
                  placeholder="Try searching for a church or county..."
                  class="w-full px-5 py-3 pr-12 text-sm text-gray-900 placeholder-gray-500 bg-white border border-gray-300 rounded-full shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 focus:outline-none"
                />
                <button
                  type="submit"
          ...
          <p class="mt-8 text-sm text-gray-500">
            Need help? <a href="/data" class="font-medium text-primary-600 hover:text-primary-700">Download church data</a> or <a href="/networks" class="font-medium text-primary-600 hover:text-primary-700">browse networks</a>
          </p>
        </div>
      </div>
    </div>
