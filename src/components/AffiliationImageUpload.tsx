...
interface AffiliationImageUploadProps {
  affiliationImages: Array<{
    id: number;
    imagePath: string;
...
export const AffiliationImageUpload: FC<AffiliationImageUploadProps> = ({ 
  affiliationImages = [], 
  domain, 
  r2Domain,
  affiliationId 
  ...
  return (
    <div class="sm:col-span-6">
      <label class="block text-sm font-medium leading-6 text-gray-900 mb-4">Affiliation Images</label>

      {/* Existing Images */}
      {affiliationImages.length > 0 && (
        <div class="mb-6">
          ...
          <div id="sortable-images" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {affiliationImages.map((image, index) => (
              <div
                key={image.id}
                  ...
                  <div class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden">
                    {image.blurhash && image.width && image.height ? (
                      <BlurhashImage
                        ...
                        alt={image.imageAlt || 'Affiliation image'}
                        width={image.width}
                        height={image.height}
        ...
        >
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
              <label for="affiliationImages" class="relative cursor-pointer rounded-md font-medium text-primary-600 hover:text-primary-500">
                <span>Upload images</span>
                <input
                  type="file"
                  id="affiliationImages"
                  name="newImages"
                  accept="image/*"
                  multiple
                  class="sr-only"
      ...
      {/* Hidden input for affiliation ID if editing */}
      {affiliationId && <input type="hidden" name="affiliationId" value={affiliationId} />}
      ...
      <script
        ...
        const fileInput = document.getElementById('affiliationImages');
