        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            function openImageModal(imageData) {
              ...
              // Create modal with fixed structure
              ...
              // Create close button with fixed positioning
              modal.innerHTML = \`
                <button onclick="closeImageModal()" class="fixed top-4 right-4 text-white hover:text-gray-300 z-50 p-2 rounded-full bg-black bg-opacity-50 hover:bg-opacity-75 transition-all">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                  </svg>
                </button>
                <div id="modal-content-container" class="relative max-w-4xl max-h-full">
